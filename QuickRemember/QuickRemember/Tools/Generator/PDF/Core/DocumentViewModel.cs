    ...
    public class DocumentViewModel : IDocument
    {
        ...
        public void Compose(IDocumentContainer container)
        {
            ...
            container.Page(page =>
            {
                ...
                page.MarginLeft((float)Page.Margin.Left);
                page.MarginRight((float)Page.Margin.Right);
                page.MarginTop((float)Page.Margin.Top);
                page.MarginBottom((float)Page.Margin.Bottom);
        ...
        {
            float height = (float)((Page.Height - Page.Margin.Top - Page.Margin.Bottom -
               Grid.VerticalSpacing * (Grid.RowDefinitions - 1)) / (float)Grid.RowDefinitions);

            float width = (float)((Page.Width - Page.Margin.Left - Page.Margin.Right -
